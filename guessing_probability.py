"""
This script defines two related functions that calculate the guessing 
probability of a given operator via semi-definite programming. See references
in the README file of this repository for the definition of the guessing 
probability.

This script contains two functions:

	> guessing_probability 			this function calculates the guessing 
									probability of an operator by minimising a 
									given trace quantity over a set of 
									unnormalised combs derived from the 
									operator;
	> list_guessing_probability 	same as the above function but specialised  
									to expressions that are 1-dimensional, i.e.
									operators with only diagonal entries.
